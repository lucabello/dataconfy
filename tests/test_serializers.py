...
class TestSerializer:
    ...
    def test_serialize_yaml(self):
        ...
        obj = TestDataClass(name="test_yaml", value=100)
    ...
    def test_serialize_json(self):
        ...
        obj = TestDataClass(name="test_json", value=200)
    ...
    def test_serialize_dataclass_type(self):
        ...
        with pytest.raises(InvalidDataclassError):
            Serializer.serialize(TestDataClass, "yaml")
    ...
    def test_deserialize_yaml(self):
        ...
        result = Serializer.deserialize(content, TestDataClass, "yaml")
    ...
    def test_deserialize_json(self):
        ...
        result = Serializer.deserialize(content, TestDataClass, "json")
    ...
    def test_deserialize_unsupported_format(self):
        ...
        with pytest.raises(UnsupportedFormatError):
            Serializer.deserialize(content, TestDataClass, "xml")

    def test_roundtrip_yaml(self):
        """Test YAML serialize/deserialize roundtrip."""
        original = TestDataClass(name="roundtrip", value=999)

        serialized = Serializer.serialize(original, "yaml")
        deserialized = Serializer.deserialize(serialized, TestDataClass, "yaml")
    ...
    def test_roundtrip_json(self):
        ...
        original = TestDataClass(name="roundtrip", value=888)

        serialized = Serializer.serialize(original, "json")
        deserialized = Serializer.deserialize(serialized, TestDataClass, "json")
